...
function startAnimation() {
        ...
        poly2 = new google.maps.Polyline({path: [polyline.getPath().getAt(0)], strokeColor:"#0000FF", strokeWeight:5});
...
function initMap() {
  var map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 50.92134,  lng: 34.76771},
    zoom: 19,
    mapTypId:google.maps.MapTypeId.ROADMAP/*Добавляем возможность */
  });
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function(position) {
      ...
      infoWindow.setContent('Мое метоположение.');
      map.setCenter(pos);
    }, function() {
